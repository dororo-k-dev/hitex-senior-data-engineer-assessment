...
class HitexDataProcessor:
    ...
    def _create_sample_data(self):
        ...
        sample_data = {
            ...
            'product_id': [f'PROD_{i%100:03d}' for i in range(1000)],
            'customer_id': [f'CUST_{i%200:04d}' for i in range(1000)],
            'channel': np.random.choice(['Amazon_FBA', 'Shopify_DTC'], 1000),
            'quantity': np.random.randint(1, 10, 1000),
            'unit_price': np.round(np.random.uniform(10, 200, 1000), 2),
